  ...
  const [cardList]: any = useState([
    {
      ...
      title: (
        <h2 className="text-white font-bold xl:text-xl lg:text-lg">
          Banco de <br></br>perguntas
        </h2>
      ),
      backgroundColor: "bg-boschPurple",
      nav: "/questions",
      description:
        "Aqui é onde você vê as perguntas que foram adicionadas ao banco",
      className: "",
    },
    {
      key: 2,
    ...
    },
    {
      ...
      title: (
        <h2 className="text-white font-bold xl:text-xl lg:text-lg">
          Enviar <br></br>Formulário de Indicação
        </h2>
      ),
