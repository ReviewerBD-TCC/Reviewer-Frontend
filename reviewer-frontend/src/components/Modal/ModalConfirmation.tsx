        ...
        <>{props.isOpen && (
            <div className="fixed inset-0 z-50 flex items-center justify-center" onClick={props.toggle}>
                <div className="flex justify-center items-center bg-black bg-opacity-40 w-full h-full ">
                    <div className="flex bg-boschWhite w-[40rem] h-auto pt-6 pb-6 pl-8 pr-8 flex-col" onClick={(e)=>e.stopPropagation()}>
                        <div className="w-full h-auto flex flex-col justify-center gap-8 m-auto">
                            ...
                            <div className="flex justify-end gap-2">
                                <SparkButton text={props.modalSecondButtonText} pallete="secondary" onClick={props.toggle} customWidth="100px" />
                                <SparkButton text={props.modalButtonText} pallete="primary" onClick={()=>deleteForm(accessToken, props.formId )} customWidth="100px" />
                            </div> 
                        </div>
                    </div>
                </div>
